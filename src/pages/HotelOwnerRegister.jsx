...
export default function HotelOwnerRegister() {
  ...
  const completeRegistration = async () => {
    ...
    const payload = {
      ...
      destinations: destinations.map(({ id, ...rest }) => rest),
      images,
    };
      ...
      {showSuccess && (
        <div className="hor-overlay" onClick={() => setShowSuccess(false)}>
          <div className="hor-overlay-card" onClick={e => e.stopPropagation()}>
            ...
            <h2 className="hor-success-title">Registration Successful!</h2>
            <p className="hor-success-text">Your hotel has been registered in our system. You can now manage it from your dashboard.</p>
